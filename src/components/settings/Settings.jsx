            ...
            <div className="section-header">
              <div className="header-content">
                <div className="header-title">
                  <h2 dir="ltr" aria-level="2" role="heading" id="root-header">
                    Settings
                  </h2>
                </div>
              </div>
            ...
            <div className="content">
              <div className="info">
                <p>
                  ...
                  your data, or learn about your <br /> account deactivation
                  options
                </p>
              </div>
              <div className="options">
                <div className="option">
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    class="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1bwzh9t"
                    width="30"
                    height="30"
                    fill="white"
                  >
                ...
                <div className="option">
                  {/* Здесь надо прописать открытие модалки */}
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    width="30"
                ...
                <div className="noti-position">
                  <div aria-live="polite" role="status" class="notification">
                    <div class="icon">
                      <svg viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M12 1.75C6.34 1.75 1.75 6.34 1.75 12S6.34 22.25 12 22.25 22.25 17.66 22.25 12 17.66 1.75 12 1.75zM13 17h-2v-5h2v5zm-1-7c-.83 0-1.5-.67-1.5-1.5S11.17 7 12 7s1.5.67 1.5 1.5S12.83 10 12 10z"></path>
                      </svg>
                    </div>
                    <div class="text">
                      <span class="title">Teams has moved</span>
                      <span class="description">
                        We moved the Teams feature to Delegate in your security
                        and account access settings. <br />
                      </span>
                      <a
